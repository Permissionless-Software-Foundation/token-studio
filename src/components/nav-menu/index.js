      ...
      <Navbar collapseOnSelect expand='xxxl' bg='dark' variant='dark' style={{ paddingRight: '20px' }}>
        ...
        <Navbar.Collapse id='responsive-navbar-nav' style={{ paddingLeft: '20px' }}>
          <Nav className='mr-auto'>
            <Nav.Link href='#' onClick={() => handleClickEvent(0)}>Create NFT</Nav.Link>
            <Nav.Link href='#' onClick={() => handleClickEvent(1)}>BCH</Nav.Link>
            <Nav.Link href='#' onClick={() => handleClickEvent(2)}>Tokens</Nav.Link>
            <Nav.Link href='#' onClick={() => handleClickEvent(3)}>Sweep</Nav.Link>
